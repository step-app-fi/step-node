...
RUN apt-get update && apt-get install -y bash=5.0-4 git=1:2.20.1-2+deb10u3 make=4.2.1-1.2 gcc=4:8.3.0-1 musl-dev=1.1.21-2 ca-certificates=20200601~deb10u2 linux-headers-amd64
ARG SUBNET_NAME
ARG SUBNET_ID
ARG VM_ID
ARG BLOCKCHAIN_ID
